<%@ Page Language="VB" AutoEventWireup="false" CodeFile="admin_seats.aspx.vb" Inherits="Admin_admin_seats" %>
         ...
         <table id="table1" style="width: 1024px; border-color:White;">
            <tr>
                <td class="style9" style="background-color: #09A0CF" colspan="3">
                    ...
                    <asp:Button ID="Button6" runat="server" Text="Manage Seats" CssClass="button" BackColor="#F86756"/>
                    </td>
            </tr>
            </table>
            </div>
...
<asp:Label ID="lblDateToday" runat="server" Font-Bold="True" 
            ...
            <tr>
                ...
                <td colspan="6">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        CellPadding="3" DataSourceID="SeatsSqlDataSource" Width="944px" 
            ...
            <tr>
                ...
                <td class="style21" colspan="6">
                    ...
                    <asp:Panel ID="Panel1" runat="server" Height="362px" Width="966px">
                        <table class="style37">
                            <tr>
                                <td colspan="3" 
                            ...
                            <tr>
                                <td class="style45">
                                    <asp:Label ID="Label1" runat="server" Text="Seat ID"></asp:Label>
                                </td>
                                <td class="style46">
                            ...
                            <tr>
                                <td class="style39">
                                    <asp:Label ID="Label2" runat="server" Text="Seat Gold"></asp:Label>
                                </td>
                                <td class="style40">
                            ...
                            <tr>
                                <td class="style39">
                                    <asp:Label ID="Label3" runat="server" Text="Seat Silver"></asp:Label>
                                </td>
                                <td class="style40">
                            ...
                            <tr>
                                <td class="style39">
                                    <asp:Label ID="Label4" runat="server" Text="Seat Platinum"></asp:Label>
                                </td>
                                <td class="style40">
                            ...
                            <tr>
                                <td class="style39">
                                    <asp:Label ID="Label15" runat="server" Text="Seat Total"></asp:Label>
                                </td>
                                <td class="style40">
                            ...
                            <tr>
                                <td class="style39">
                                    <asp:Label ID="Label16" runat="server" Text="Cost Gold"></asp:Label>
                                </td>
                                <td class="style40">
                            ...
                            <tr>
                                <td class="style39">
                                    <asp:Label ID="Label22" runat="server" Text="Cost Silver"></asp:Label>
                                </td>
                                <td class="style40">
                            ...
                            <tr>
                                <td class="style39">
                                    <asp:Label ID="Label23" runat="server" Text="Cost Platinum"></asp:Label>
                                </td>
                                <td class="style40">
                    ...
                    <asp:Panel ID="Panel2" runat="server" CssClass="style53" Height="148px">
                        <table class="style52">
                            <tr>
                                <td colspan="3" 
                            ...
                            <tr>
                                ...
                                <td class="style26">
                                    <asp:DropDownList ID="DropDownList1" runat="server" 
                                        DataSourceID="SeatsSqlDataSource" DataTextField="SeatID" 
                    ...
                    <asp:Panel ID="Panel3" runat="server" CssClass="style54">
                        <table class="style68">
                            ...
                            <tr>
                                <td class="style31">
                                    <asp:Label ID="Label6" runat="server" Text="Select Seat"></asp:Label>
                                </td>
                                <td class="style35">
                                    &nbsp;
                                    <asp:DropDownList ID="DropDownList2" runat="server" 
                                        DataSourceID="SeatsSqlDataSource" DataTextField="SeatID" 
                                        DataValueField="SeatID" AutoPostBack="True">
                                    </asp:DropDownList>
                                </td>
                                <td class="style29">
                                    &nbsp;
                            ...
                            <tr>
                                <td class="style32">
                                    <asp:Label ID="Label7" runat="server" Text="Seat Gold"></asp:Label>
                                </td>
                                <td class="style34">
                            ...
                            <tr>
                                <td class="style31">
                                    <asp:Label ID="Label8" runat="server" Text="Seat Silver"></asp:Label>
                                </td>
                                <td class="style35">
                            ...
                            <tr>
                                <td class="style31">
                                    <asp:Label ID="Label9" runat="server" Text="Seat Platinum"></asp:Label>
                                </td>
                                <td class="style35">
                            ...
                            <tr>
                                <td class="style31">
                                    <asp:Label ID="Label17" runat="server" Text="Seat Total"></asp:Label>
                                </td>
                                <td class="style35">
                            ...
                            <tr>
                                <td class="style31">
                                    <asp:Label ID="Label18" runat="server" Text="Cost Gold"></asp:Label>
                                </td>
                                <td class="style35">
                            ...
                            <tr>
                                <td class="style70">
                                    <asp:Label ID="Label24" runat="server" Text="Cost Silver"></asp:Label>
                                </td>
                                <td class="style47">
                            ...
                            <tr>
                                <td class="style31">
                                    <asp:Label ID="Label25" runat="server" Text="Cost Platinum"></asp:Label>
                                </td>
                                <td class="style35">
            ...
            <tr>
                <td class="style49">
                    &nbsp;</td>
                <td colspan="6">
                    <asp:SqlDataSource ID="SeatsSqlDataSource" runat="server" 
